// Scoped to players-portal.html only (see registration call). No caching/
// offline behavior — this exists purely so the page satisfies installability
...
// sent by the send-players-portal-push Edge Function whenever Matthew
// opens the doors, calls a match, or turns the light green.
self.addEventListener('push', function (event) {
  var data = {}
  try { data = event.data ? event.data.json() : {} } catch (e) {}
  var title = data.title || 'AADS Players Portal'
  event.waitUntil(
